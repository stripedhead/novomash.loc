...
<div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
	<a href="<?php echo $root_dir.$FL."order.php";?>" class="btn btn-default btn-sm" role="button" title="Контактная форма"><strong>ФОРМА СВЯЗИ</strong></a>
	<a href="#" class="btn btn-default btn-sm disabled" role="button" title="Задать вопрос специалисту"><i class="fa fa-life-ring"></i> Задать вопрос</a>
</div>
<div class="panel-bar-bottom">
<small>Если у Вас возникли вопросы или хотите получить консультацию специалиста</small>
</div>
</div>
<!-- Панель опросных листов -->
<div class="panel-bar-main">
<div class="btn-group btn-group-justified" role="group" aria-label="Justified button group">
	<a href="<?php echo $root_dir.$FL."opros-list.php";?>" class="btn btn-default btn-sm" role="button" title="Весь перечень опросных листов"><strong>ОПРОС ЛИСТЫ</strong></a>
	<?php 
...
<div class="panel-bar-bottom">
<small>Документы для подбора конвейерного оборудования <?php echo $corp_name;?> в формате MS Word 2010</small>
</div>
</div>
<!-- <div class="list-group" style=" margin-top:15px;">
<a href="#opisanie" class="list-group-item">Основные характеристики</a>
</div> -->
</div>
