...
<meta name="author" content="<?php echo $init_arr[2];?>">
...
<title><?php if ($product_info[0] == NULL) {echo $def_TITLE_PAGE;} else {echo $product_info[0];}?></title>
...
<link rel="stylesheet" type="text/css" href="<?php echo $dir_css.$FL;?>ekko-lightbox.min.css">
<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
<!--[if lt IE 9]>
<script src="<?php echo $dir_html5shiv;?>"></script>
<script src="<?php echo $dir_respond;?>"></script>
<link rel="stylesheet" type="text/css" href="<?php echo $dir_css.$FL;?>ie.css">
<![endif]--><?php }	else {?>
